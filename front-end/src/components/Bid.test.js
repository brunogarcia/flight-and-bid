...
describe('Bid component', () => {
  it('renders a Card component', () => {
    const wrapper = shallow(<Bid idx={props.idx} meals={props.meals} journey={props.journey} onFinishProcess={props.onFinishProcess} />);
  ...
  it('renders a NumericInput component', () => {
    const wrapper = shallow(<Bid idx={props.idx} meals={props.meals} journey={props.journey} onFinishProcess={props.onFinishProcess} />);
    wrapper.setState({ mealId: 'test' });
    expect(wrapper.find(NumericInput).exists()).toBeTruthy();
  });
});
